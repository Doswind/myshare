...
class CrawlConfig(Base):
    ...
    time_of_day = Column(String(5), default="17:00", comment="daily / weekly 模式下的触发时间")
    # weekly 时使用（0=周一 ... 6=周日，同 APScheduler day_of_week）
    day_of_week = Column(Integer, default=0, comment="weekly 模式下的星期（0=周一 ... 6=周日）")
